...
import fr.enderitefox.redstoneassembler.core.redstone_assembly.instruction_readers.*;
...
public class RedstoneAssembler implements Assembler {
    ...
    @Override
    public List<Short> readProgram(List<String> program) throws InternalError, IllegalArgumentException {
